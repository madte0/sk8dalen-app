    ...
    <div className="min-h-screen bg-black text-white p-8">
      ...
      <div className="bg-zinc-900 p-8 rounded-xl mb-8 text-center">
        ...
        {currentRun ? (
          ...
          <div className="text-yellow-400">
            Waiting for Admin to start run
          </div>
        )}
      ...
      <div className="bg-zinc-900 p-8 rounded-xl mb-10">
        ...
        <div className="mb-6">
          ...
          <input type="range" min="8" max="14" value={difficulty} onChange={(e)=>setDifficulty(Number(e.target.value))} className="w-full"/>
        </div>

        <div className="mb-6">
          <label>Style: {style}</label>
          <input type="range" min="8" max="14" value={style} onChange={(e)=>setStyle(Number(e.target.value))} className="w-full"/>
        </div>

        <div className="mb-8">
          <label>Consistency: {consistency}</label>
          <input type="range" min="8" max="14" value={consistency} onChange={(e)=>setConsistency(Number(e.target.value))} className="w-full"/>
        </div>
